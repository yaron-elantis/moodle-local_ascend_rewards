...
function showAvatarSuccessModal(name, videoFile) {
    ...
    content.innerHTML = 
        ...
        '<div style="width:100%;max-width:250px;aspect-ratio:1;border-radius:50%;overflow:hidden;border:3px solid #06b6d4;margin:0 auto 16px;background:#000;">' +
...
function showAvatarReviewModal(avatarFile, name, videoFile) {
    ...
    content.innerHTML = 
        ...
        '<div style="width:100%;max-width:250px;aspect-ratio:1;border-radius:50%;overflow:hidden;border:3px solid #FFD700;margin:0 auto 16px;background:#000;">' +
...
function showPetSuccessModal(petName, videoFile, unlockType, newBalance) {
    ...
    content.innerHTML = 
        ...
        '<div style="margin-bottom:12px;font-size:16px;font-weight:600;color:#e6e9f0;">' + petName + '</div>' +
        '<div style="width:100%;max-width:250px;border-radius:50%;overflow:hidden;border:3px solid #FF9500;margin:0 auto 16px;aspect-ratio:1;background:#000;">' +
...
function showPetReviewModal(petName, petId, videoFile) {
    ...
    content.innerHTML = 
        ...
        '<div style="width:100%;max-width:250px;border-radius:50%;overflow:hidden;border:3px solid #ec4899;margin:0 auto 16px;aspect-ratio:1;background:#000;">' +
...
function showVillainSuccessModal(villainName, villainImageName, villainVideo, unlockType, newBalance) {
    ...
    content.innerHTML = 
        ...
        '<div style="margin-bottom:12px;font-size:16px;font-weight:600;color:#e6e9f0;">' + villainName + '</div>' +
        '<div style="width:100%;max-width:250px;border-radius:50%;overflow:hidden;border:3px solid #dc2626;margin:0 auto 16px;aspect-ratio:1;background:#000;">' +
...
function showVillainReviewModal(villainName, villainId, villainImageName, villainVideo) {
    ...
    content.innerHTML = 
        ...
        '<div style="width:100%;max-width:250px;border-radius:50%;overflow:hidden;border:3px solid #06b6d4;margin:0 auto 16px;aspect-ratio:1;background:#000;">' +
