...
/**
 * Legacy AJAX endpoint for mystery box opening.
 *
 ...
 * service: local_ascend_rewards_mysterybox_open.
 *
...
try {
    ...
    $result = \local_ascend_rewards\ajax_service::mysterybox_open($price);
