...
/**
 * Weekly Gameboard System
 * Each badge earned gets its own gameboard
 * Meta badges allow 2 picks on their gameboard
 */
class local_ascend_rewards_gameboard {
    ...
    public static function has_earned_badges_this_week($userid) {
        ...
        list($week_start, $week_end) = self::get_week_range();
